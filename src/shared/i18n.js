...
const STRINGS = {
  id: {
    ...
    heroSubtitle:
      "Ini bukan cuma bacaan sekali selesai. Scan hasil MCU tiap kali kamu periksa lewat akun 20FIT — langsung kelihatan gambaran hasilnya, dan tersimpan supaya bisa kamu pantau perubahannya dari waktu ke waktu.",
    ...
    faq: [
      {
        ...
        a: "Ya. Untuk menjaga data kesehatanmu, dokumen MCU cuma diproses AI setelah kamu masuk ke akun 20FIT. Akun ini juga yang dipakai untuk menyimpan riwayat dan melihat perbandingan antar periode.",
      },
      {
        q: "Apakah file hasil lab saya disimpan?",
        a: "Tidak. Filenya diproses untuk dianalisa lalu dibuang — hanya ringkasan hasilnya yang disimpan ke akunmu, bukan file aslinya.",
      },
      {
    ...
    confirmTitle: "Konfirmasi dokumen MCU",
    confirmDetectedName: "Nama pasien",
    confirmDocType: "Jenis dokumen",
    confirmDocTypeValue: "Hasil MCU / Lab",
    confirmGradeLabel: "Skor kesehatan",
    confirmNameMismatchTitle: "Nama tidak sesuai",
    confirmNameDoc: "Nama di dokumen",
    confirmNameAccount: "Nama akun kamu",
    confirmNameMismatchHint: "Pastikan ini benar-benar hasil MCU milikmu sendiri.",
    consent1: "Dokumen ini adalah hasil MCU milik saya sendiri.",
    consent2: "Saya paham analisis ini dibuat AI, bukan pengganti diagnosis dokter.",
    consent3: "Saya bertanggung jawab atas keakuratan dokumen yang saya unggah.",
    confirmSave: "Simpan hasil MCU",
    confirmCancel: "Batal",
    savedToast: "Hasil MCU berhasil dianalisa & disimpan ke riwayatmu.",
    ...
    topicLab: "Hasil Lab",
    topicNutrition: "Gizi",
    topicActivity: "Aktivitas",
    topicConsult: "Konsultasi",
    topicLifestyle: "Gaya Hidup",
    topicMcu: "Seputar MCU",
  ...
  en: {
    ...
    heroSubtitle:
      "This isn't a one-time read. Scan your MCU every time you get checked, through your 20FIT account — you'll see the result right away, and it's saved so you can track the change over time.",
    ...
    faq: [
      {
        ...
        a: "Yes. To protect your health data, a document is only ever analyzed by AI after you sign in to a 20FIT account. That same account is what saves your history and lets you see period-over-period comparisons.",
      },
      {
        q: "Is my lab file stored?",
        a: "No. Your file is processed for analysis and then discarded — only the result summary is saved to your account, never the original file.",
      },
      {
    ...
    confirmTitle: "Confirm your MCU document",
    confirmDetectedName: "Patient name",
    confirmDocType: "Document type",
    confirmDocTypeValue: "Medical checkup / lab result",
    confirmGradeLabel: "Health score",
    confirmNameMismatchTitle: "Name doesn't match",
    confirmNameDoc: "Name on the document",
    confirmNameAccount: "Your account name",
    confirmNameMismatchHint: "Please make sure this is really your own MCU result.",
    consent1: "This is my own MCU result.",
    consent2: "I understand this analysis is AI-generated, not a substitute for a doctor's diagnosis.",
    consent3: "I'm responsible for the accuracy of the document I upload.",
    confirmSave: "Save MCU result",
    confirmCancel: "Cancel",
    savedToast: "Your MCU result was analyzed and saved to your history.",
    ...
    topicLab: "Lab Results",
    topicNutrition: "Nutrition",
    topicActivity: "Activity",
    topicConsult: "Consultation",
